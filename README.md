...
## Skirmish
- Like AAS but on a smaller map with fewer players. Sounds good to train, but gives the wrong impression about scale, distances, vehicles, etc. in the game. Would not recommend to play this game mode first as a new player.
...
- For your first game: Jump on a full server (you might need to wait a few minutes in the Queue, that's fine, don't join if the queue is > 5ppl). Preferably you should join a server in your native language to make communication easy. Join a Squad. If none are open, be patient, there will be one available in a few minutes. Have fun! Tell your Squad Leader you are new and need guidance. Follow you SLs orders and kick some ass.
...
- Don't say "Enemy on me". Not in local chat and especially not in squad chat. Other players do not know who said "On me". If they are quick enough to spot your name in the voice chat notification they would still have to open their map and then find where you are. Say at least "Enemy on YOURNAMEHERE's position" and give some indication on where you are. 
	...
	- For example:
		...
		- "Enemy armour spotted, south of Market, approx. 100 meters"
...
## Firefights
- Any time you are under fire you need to be shooting back, it is literally the only chance you have in some cases. This game is centered around one of the best suppression models I have seen to date in a game. If you are being shot at, shoot back. Can't see them? Guess. You might be right. If anything it might get the enemies head down and gives you a chance. The moment you return fire, even if just in the direction of fire, you created a 2-way firing range, and the entire tempo has changed. You now have him surprised, off guard, possibly suppressed, maybe wounded, possible dead with enough lead and luck.
...
- In a firefight with multiple downed friendlies, when reviving, give each person a quick tap with the Medic bag (don't fully heal them). This quick tap allows your friend to begin building stamina, and therefore allows them to aim better and help defend while you go and get to another person. Go back when it's clear/everyone is up and then begin full healing them.
...
The Crewmen have to exit their vehicle, and repair over a long time the tracks from outside to get the vehicle moving again. In this time, they are sitting ducks for any enemy vehicle or to more ATs that are then focused on damaging the vehicle. Oftentimes ATs will even push around the vehicle to kill the guy trying to repair it.
    If they are killed the armor is almost always lost. If no one comes to rescue them the gunner is either trapped in one position and forced to endure further attacks of rockets or they also try to get out and risk to lose the vehicle altogether if they get killed.
...
- Talking to command and asking for enemy armored locations helps but it is usually called out anyways for all squads to know (and marked on the map). Use this knowledge to guess the enemy's intent based on location (to objectives or friendly's). This will aid in your survival and their death.
...
- Invasion Defense - Plan ahead and try to fit at least two FOBs next to the flags. It's crucial you get to the first (closest to enemy) objective swiftly, it's easiest to win by stopping the enemy on the first point. Again, keep your logis safe and accessible, definitely destroy them if recovery is unlikely to succeed.
...
- The Building Procedure:
    - Choose a single squad mate (make sure they understood you) who will unload a specified amount of supplies (most likely half, start with CPs), and shovel the HAB up.
...
* Humvee - US up-armored basic transport armed with a M2 heavy machine gun either in a manned turret or in a CROWS remote controlled turret.
...
* Technical or Techi (teck-e) - reference to the Insurgent/Militia force’s Technical Trucks. Can also refer specifically to the Armed Technical Truck. Usually pickup trucks with guns mounted on the back.
...
- This can be used when calling out certain locations on the map. Instead of saying "M7" you'd say "Mike 7". 
